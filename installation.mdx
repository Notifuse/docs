...
[<img src="/assets/northflank-button.svg" alt="Deploy on Northflank" width="147" noZoom />](https://northflank.com/stacks/deploy-notifuse)
...
| `SMTP_BRIDGE_PORT`                   | SMTP bridge port (e.g., `587` for STARTTLS)                                                | `587`                                |
| `SMTP_BRIDGE_DOMAIN`                 | Public domain name for SMTP bridge (e.g., `smtp.yourdomain.com`)                           | `localhost`                          |
| `SMTP_BRIDGE_TLS_CERT_BASE64`        | Base64-encoded TLS certificate for SMTP bridge                                             | -                                    |
| `SMTP_BRIDGE_TLS_KEY_BASE64`         | Base64-encoded TLS private key for SMTP bridge                                             | -                                    |
|                                     |
