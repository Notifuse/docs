...
The SMTP Relay feature allows you to send transactional emails using standard SMTP clients instead of HTTP API calls. This is useful for integrating legacy systems or using standard email libraries.
