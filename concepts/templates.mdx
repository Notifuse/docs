...
<p>Thank you for subscribing to {{ list.name }}. We're excited to have you on board!</p>

<p>Your registered email: {{ contact.email }}</p>

<div style="margin: 20px 0;">
  <a href="{{ notification_center_url }}" style="background: #007bff; color: white; padding: 10px 20px; text-decoration: none;">
    Manage Preferences
  </a>
</div>
...
```json
{
  ...
  "unsubscribe_url": "https://your_notifuse_endpoint.your_website.com/unsubscribe?email={{ contact.email }}&lid={{ list.id }}&email_hmac={{ contact.hmac }}",
